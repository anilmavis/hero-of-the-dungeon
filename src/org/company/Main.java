...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Hero hero = new Hero(name, null, null, 20);

        switch (scanner.nextInt()) {
            case 1:
                hero = new Hero(name, WeaponInstance.glassShank(), ClothingInstance.strappedLeather(), 20);
                break;
            case 2:
                hero = new Hero(name, WeaponInstance.rustedHatchet(), ClothingInstance.plateVest(), 20);
                break;
            case 3:
                hero = new Hero(name, WeaponInstance.crudeBow(), ClothingInstance.shabbyJerkin(), 20);
                break;
            default:
                break;
        }
